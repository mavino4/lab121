...
\umlclass[x=8,y=0]{AddRecursos : Form}
{ - archR : ArchRec\\
}{ + AddRecursos() : void \\
+ AdicionarClick() : void\\
}

\umlclass[x = 8 , y = -5] {Prestar : Form}
{  - archE : ArchEst\\
- archR : ArchRec\\
}{ + Prestar() : void \\
+ PrestarClick() : void\\
...
\umlclass[x = 8 , y = -10]{Devolver : Form}
{  - archE : ArchEst\\
- archR : ArchRec\\
}{ + Devolver() : void \\
+ DevolverClick() : void\\
...
\umlclass [x = 0 , y = -7]{QuienTieneY : Form}
{  - archE : ArchEst\\
- archR : ArchRec\\
}{ + QuienTieneY() : void \\
+ ConsularClick() : void\\
...
\umlclass[x = 0 , y = -12]{AddEst : Form}
{  - archE : ArchEst\\
}{ + AddEst() : void \\
+ AddEstClick() : void\\
}

\umlclass[x = 8 , y = -17]{QueDebeX : Form}
{  - archE : ArchEst\\
- archR : ArchRec\\
}{ + QueDebeX() : void \\
+ ConsularClick() : void\\
